...
import br.com.etec.projetoum.service.CidadeService;
...
public class CidadeResource {
	...
	@GetMapping()
	public Page<Cidade> pesquisarNome(@RequestParam(required = false, 
			defaultValue = "")String nome, Pageable pageable){
		return cidadeService.pesquisarNome(nome, pageable);
	}
